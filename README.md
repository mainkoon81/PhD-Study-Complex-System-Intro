...
`Some small change in input value to the **system** can (via feedback loops) trigger a large sysmetic effect that is a **combined effect** greater/less than the simple sum of each element's property because of their interdependent nature.` This is referred to as **sensitivity of initial conditions** which is the central idea of the Chaos theory. 
